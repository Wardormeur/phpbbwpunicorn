...
$lang = array_merge($lang, array(
	...
	'WP_CACHE'			=> 'Regenerate temporary files (shoud be done if the creation of user trigger an error, or if you changed the wordpress path)',
	'WP_SYNC_AVATAR'			=> 'Use phpbb avatar for wordpress (will resync every user)',
	'WP_RESYNC'			=> 'Resynchronize every user (care with article ownership..(not handled yet))',
